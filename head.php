...
<body>
  <div class="header">
    <a href="home.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>RED LIFE </a>
    ...
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate?</a>
      <a href="donate_blood.php"  <?php if($active=='donate') echo "class='act'"; ?>>Become A Blood Donor</a>
      <a href="need_blood.php" <?php if($active=='need') echo "class='act'"; ?>>Require Blood</a>
